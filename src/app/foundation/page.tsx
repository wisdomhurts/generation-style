      ...
      <div className="max-w-6xl mx-auto">
        ...
        <section id="design-tokens" className="scroll-mt-24 mb-28">
          <div className="flex items-baseline gap-4 mb-10">
            ...
            <span className="font-mono text-[#7CC842] text-xs tracking-wider">5 TOKENS</span>
          </div>
            ...
            {coreTokens.map((token) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div>
                      <p className={`font-display font-bold text-xl ${isLight ? "text-[#2D3748]" : "text-white"}`}>
                        {token.name}
                      </p>
                      <p className={`font-mono text-xs mt-1 ${isLight ? "text-[#2D3748]/60" : "text-white/60"}`}>
                        {token.hex}
                      </p>
                    </div>
                  </div>
        ...
        <section id="extended-palette" className="scroll-mt-24 mb-28">
          ...
          <div className="flex items-baseline gap-4 mb-10">
            ...
            <span className="font-mono text-[#7CC842] text-xs tracking-wider">7 TOKENS</span>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
            {extendedTokens.map((token) => {
              ...
              return (
                <div key={token.name} className="rounded-xl overflow-hidden card-hover bg-white group">
                  <div
                    className="h-28 flex items-end p-4"
                    style={{ backgroundColor: token.hex }}
                  >
                    <div>
                      <p className={`font-display font-semibold text-sm ${isLight ? "text-[#2D3748]" : "text-white"}`}>
                        {token.name}
                      </p>
                      <p className={`font-mono text-[10px] mt-0.5 ${isLight ? "text-[#2D3748]/60" : "text-white/60"}`}>
                        {token.hex}
                      </p>
                    </div>
                  </div>
                  <div className="p-4">
                    <p className="text-xs text-[#4A5568] leading-relaxed">{token.usage}</p>
                  </div>
                </div>
              );
            })}
        ...
        <section id="typography" className="scroll-mt-24 mb-28">
          ...
          <div className="flex items-baseline gap-4 mb-12">
            ...
            <span className="font-mono text-[#7CC842] text-xs tracking-wider">3 FONTS</span>
          </div>

          {/* Outfit Display */}
          <div className="mb-16">
            <p className="mono-label mb-8">DISPLAY — OUTFIT</p>
            <div className="space-y-8 border-l-2 border-[#7CC842]/30 pl-8">
              <div className="bg-white rounded-xl p-8 border border-[#E8E5DD]">
                <p className="font-mono text-[10px] text-[#7CC842]/60 tracking-wider mb-3">72px / HERO</p>
                <p className="font-display font-bold text-[72px] leading-[1.05] text-[#2D3748] tracking-tight">
                  Power
                </p>
              </div>
              <div className="bg-[#F5F3ED] rounded-xl p-8 border border-[#E8E5DD]">
                <p className="font-mono text-[10px] text-[#7CC842]/60 tracking-wider mb-3">48px / SECTION TITLE</p>
                <p className="font-display font-bold text-[48px] leading-tight text-[#2D3748]">
                  Generating Tomorrow
                </p>
              </div>
              <div className="bg-white rounded-xl p-8 border border-[#E8E5DD]">
                <p className="font-mono text-[10px] text-[#7CC842]/60 tracking-wider mb-3">32px / SUBSECTION</p>
              ...
              <div className="bg-[#F5F3ED] rounded-xl p-8 border border-[#E8E5DD]">
                <p className="font-mono text-[10px] text-[#7CC842]/60 tracking-wider mb-3">24px / CARD TITLE</p>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white rounded-xl p-8 border border-[#E8E5DD]">
                <p className="font-mono text-[#7CC842] text-xs tracking-[0.25em] mb-3">OVERLINE LABEL</p>
                <p className="font-mono text-[#7CC842] text-lg tracking-wider">
                  TSX-V: GEN
                </p>
                <p className="font-mono text-[#6B7B8D] text-xs mt-4 tracking-wider">
                  SECTION 01 &middot; FOUNDATION
                </p>
              </div>
              <div className="bg-[#F5F3ED] rounded-xl p-8">
                <p className="font-mono text-[#2D3748] text-xs tracking-[0.25em] mb-3">LIGHT CONTEXT</p>
                <p className="font-mono text-[#2D3748] text-lg tracking-wider">
                  25,000+ HECTARES
                </p>
                <p className="font-mono text-[#4A5568] text-xs mt-4 tracking-wider">
          ...
          <div className="mb-16">
            ...
            <div className="space-y-6 border-l-2 border-[#E8E5DD] pl-8">
              <div>
                <p className="font-mono text-[10px] text-[#7CC842]/60 tracking-wider mb-2">16px / BODY REGULAR</p>
              ...
              <div>
                <p className="font-mono text-[10px] text-[#7CC842]/60 tracking-wider mb-2">14px / BODY SMALL</p>
              ...
              <div>
                <p className="font-mono text-[10px] text-[#7CC842]/60 tracking-wider mb-2">12px / CAPTION</p>
                <p className="text-[12px] leading-relaxed text-[#6B7B8D]">
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={w.weight} className="bg-white rounded-xl p-6 card-hover border border-[#E8E5DD]">
                  <p className="font-mono text-[10px] text-[#7CC842]/60 tracking-wider mb-3">
                    Inter {w.weight}
                  </p>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              <button className="bg-[#7CC842] text-white font-display font-bold px-7 py-3 rounded-lg text-sm tracking-wide hover:bg-[#6AB835] transition-all duration-300">
                Primary Action
              </button>
              <button className="bg-white text-[#2D3748] font-display font-semibold px-7 py-3 rounded-lg text-sm tracking-wide border border-[#E8E5DD] hover:border-[#7CC842] transition-all duration-300">
                Secondary Action
              </button>
              <button className="border-2 border-[#7CC842] text-[#7CC842] font-display font-semibold px-7 py-3 rounded-lg text-sm tracking-wide hover:bg-[#7CC842]/10 transition-all duration-300">
                Outline Action
              </button>
            </div>
          </div>
