          ...
          {iconCategories.map((category) => (
            <div key={category.name} className="mb-20">
              <div className="flex items-baseline gap-4 mb-8">
                ...
                <span className="font-mono text-[#CBD5E0] text-xs">{category.icons.length} icons</span>
              </div>
              ...
              <div className="grid grid-cols-3 md:grid-cols-6 gap-4">
                {category.icons.map((icon) => (
                  ...
                  >
                    ...
                    <p className="font-mono text-[10px] text-[#A0AEC0] text-center tracking-wider group-hover:text-gen-green transition-colors duration-300">
                      {icon.label}
                    </p>
                  </div>
                ))}
