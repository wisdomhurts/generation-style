  ...
  },
  {
    ...
    icons: [
      ...
      },
      {
        ...
        svg: (
          <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
            <path d="M8 28C8 28 8 12 24 8C24 8 24 24 8 28Z" stroke="#F5F3ED" strokeWidth="1.5" fill="#7CC842" opacity="0.1"/>
      ...
      },
      {
        ...
        svg: (
          <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
            <circle cx="18" cy="18" r="6" fill="#7CC842" opacity="0.2" stroke="#F5F3ED" strokeWidth="1.5"/>
    ...
    <div className="py-20 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <section id="icon-system" className="scroll-mt-24">
            ...
            <div key={category.name} className="mb-20">
              ...
              <div className="grid grid-cols-3 md:grid-cols-6 gap-4">
                {category.icons.map((icon) => (
                  <div
                    key={icon.label}
                    className="bg-[#F5F3ED] rounded-xl p-5 flex flex-col items-center justify-center gap-4 card-hover group aspect-square"
                  >
          ...
          <div className="bg-[#F5F3ED] rounded-2xl p-8 md:p-12 card-hover">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <p className="text-graphite text-sm leading-relaxed">
                  ...
                  details in Chartreuse (#7CC842). On light backgrounds, swap
